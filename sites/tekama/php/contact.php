...
if(isset($_POST['email'])) {
    ...
    $email_to = "INFO@INVESTA.PRO"; /* в этой строке меняем адрес электронной почты на свой */
    $email_subject = "SMM-агентства «SAVDA»: Заказ консультации"; /* меняем тему письма на свою */
    ...
    $email_message = "SMM-агентства «SAVDA» - Запрос на консультацию .\n\n";
    ...
    $email_message .= "Телефон отправителя: ".clean_string($phone)."\n";
    $email_message .= "Email: ".clean_string($email)."\n";
	$email_message .= "Тема запроса: ".clean_string($select)."\n";
